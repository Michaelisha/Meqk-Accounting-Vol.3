  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside className={cn(
        ...
        <div className="p-6 border-b border-slate-900/10">
          ...
          <div className="flex items-center gap-3">
            <div className={cn("w-10 h-10 rounded-xl flex items-center justify-center shrink-0 shadow-md", themeStyles[theme])}>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className={cn(
          "h-20 border-b border-slate-200 flex items-center justify-between px-8 sticky top-0 z-40 backdrop-blur-md bg-opacity-80",
          moduleThemes[theme]
        )}>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-slate-600 text-[10px] uppercase tracking-widest font-bold">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-sm text-slate-600 opacity-70">{userRole || 'Active Session'}</p>
            </div>
            <div className="w-10 h-10 rounded-full bg-white/50 border border-slate-200 flex items-center justify-center text-slate-600 font-bold uppercase shadow-sm">
